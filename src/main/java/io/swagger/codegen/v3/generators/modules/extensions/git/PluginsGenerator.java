...
public class PluginsGenerator extends AbstractGenerator implements Generator {
    ...
    protected void generateModelDocumentation(List<File> files, Map<String, Object> models, String modelName) throws IOException {
        for (String templateName : plugins.modelDocTemplateFiles().keySet()) {
            String suffix = plugins.modelDocTemplateFiles().get(templateName);
            String filename = plugins.modelDocFileFolder() + File.separator + plugins.toModelDocFilename(modelName) + suffix;
